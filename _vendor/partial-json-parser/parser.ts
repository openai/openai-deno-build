...
const _parseJSON = (jsonString: string, allow: number) => {
  ...
  const parseAny: () => any = () => {
    ...
    if (
      ...
      (Allow.NULL & allow && length - index < 4 &&
    ...
    if (
      ...
      (Allow.BOOL & allow && length - index < 4 &&
    ...
    if (
      ...
      (Allow.BOOL & allow && length - index < 5 &&
    ...
    if (
      ...
      (Allow.INFINITY & allow && length - index < 8 &&
    ...
    if (
      ...
      (Allow.NAN & allow && length - index < 3 &&
...
export { MalformedJSON, PartialJSON, partialParse };
