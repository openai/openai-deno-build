...
export class EventStream<EventTypes extends BaseEvents> {
  ...
  _emit<Event extends keyof BaseEvents>(
    event: Event,
    ...args: EventParameters<BaseEvents, Event>
  ): void;
  ...
  _emit<Event extends keyof EventTypes>(
    ...
    const listeners: EventListeners<EventTypes, Event> | undefined =
...
export type EventParameters<Events, EventType extends keyof Events> = {
  [Event in EventType]: EventListener<Events, EventType> extends
