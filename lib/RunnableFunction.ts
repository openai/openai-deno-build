...
export type RunnableFunctionWithParse<Args extends object> = {
  ...
  function: (
    args: Args,
    runner:
      | ChatCompletionRunner<unknown>
      | ChatCompletionStreamingRunner<unknown>,
...
export type RunnableToolFunction<Args extends object | string> = Args extends
  string ? RunnableToolFunctionWithoutParse
