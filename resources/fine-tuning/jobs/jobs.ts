...
export class Jobs extends APIResource {
  checkpoints: CheckpointsAPI.Checkpoints = new CheckpointsAPI.Checkpoints(
    this._client,
  );
...
export namespace Jobs {
  ...
  export type FineTuningJobWandbIntegration =
    JobsAPI.FineTuningJobWandbIntegration;
  export type FineTuningJobWandbIntegrationObject =
    JobsAPI.FineTuningJobWandbIntegrationObject;
